...
@section('content')
        ...
        @endif
        <form class="layui-form" action="/admin/brand/store" enctype="multipart/form-data" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="brand_url" lay-verify="title" autocomplete="off" placeholder="请输入品牌地址" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
